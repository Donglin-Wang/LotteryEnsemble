    ...
    experiments = {
        ...
        'lottery_fl_v3_20_c_per_round_0.3_thresh':  # this key determines the output folder name under log_folder
            build_args(arch='mlp',
                       ...
                       n_samples=n_samples,
                       n_class=n_class),
        'genesis_5_c_per_round':  # this key determines the output folder name under log_folder
            build_args(arch='mlp',
                       dataset='mnist',
                       data_split='non-iid',
                       ...
                       n_samples=n_samples,
                       n_class=n_class),
        'genesis_10_c_per_round':  # this key determines the output folder name under log_folder
            build_args(arch='mlp',
                       dataset='mnist',
                       data_split='non-iid',
                       client=ClientGenesis,
                       ...
                       n_samples=n_samples,
                       n_class=n_class),
        'genesis_20_c_per_round':  # this key determines the output folder name under log_folder
            build_args(arch='mlp',
                       dataset='mnist',
                       data_split='non-iid',
                       client=ClientGenesis,
